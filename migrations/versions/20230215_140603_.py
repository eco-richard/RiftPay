...
Revision ID: c7cc7f8e97a3
Revises:
Create Date: 2023-02-15 14:06:03.958922
...
def upgrade():
    ...
    sa.Column('payers', sa.String(length=5000), nullable=True),
    sa.Column('repayments', sa.String(length=5000), nullable=True),
    ...
    if environment == "production":
        op.execute(f"ALTER TABLE transaction_users SET SCHEMA {SCHEMA};")
